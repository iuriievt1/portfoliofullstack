...
// TTL-key: если он пропал — водитель считается "стухшим" для матчинга
...
export async function findNearestDrivers(
  ...
  // фильтруем только тех, у кого TTL живой
  ...
  // чистим GEO от протухших, чтобы не копился мусор
